...
void loadShaders(bool is_reload)
{
	...
	shader = labhelper::loadShaderProgram("../project/shaders/background.vert", "../project/shaders/background.frag", is_reload);
	if (shader != 0) backgroundProgram = shader;
	shader = labhelper::loadShaderProgram("../project/shaders/shading.vert", "../project/shaders/shading.frag", is_reload);
