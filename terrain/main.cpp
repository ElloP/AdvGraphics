...
{
	GLuint shader = labhelper::loadShaderProgram("../terrain/shaders/simple.vert", "../terrain/shaders/simple.frag", is_reload);
	if (shader != 0) simpleShaderProgram = shader; 
	shader = labhelper::loadShaderProgram("../terrain/shaders/background.vert", "../terrain/shaders/background.frag", is_reload);
	if (shader != 0) backgroundProgram = shader;
	shader = labhelper::loadShaderProgram("../terrain/shaders/shading.vert", "../terrain/shaders/shading.frag", is_reload);
	if (shader != 0) shaderProgram = shader;
}

void loadShaders() {
	backgroundProgram = labhelper::loadShaderProgram("../terrain/shaders/background.vert", "../terrain/shaders/background.frag");
	shaderProgram = labhelper::loadShaderProgram("../terrain/shaders/shading.vert", "../terrain/shaders/shading.frag");
	simpleShaderProgram = labhelper::loadShaderProgram("../terrain/shaders/simple.vert", "../terrain/shaders/simple.frag");
	heightfieldProgram = labhelper::loadShaderProgram("../terrain/shaders/heightfield.vert", "../terrain/shaders/heightfield.frag");
}
...
void gui()
{
	...
	ImGui::DragFloat("Fake time", &fakeTime, 0.001f, -1.0f, 1.0f);
	ImGui::DragInt("Distribution", &distr, 1, 0, 3);
	ImGui::Checkbox("Draw Terrain", &drawTerr);
	// ----------------------------------------------------------
